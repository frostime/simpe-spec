...
**Updated**: 2026-06-27T14:12+08:00
...
- [2026-06-27T14:10+08:00] Decision: Add root `CHANGELOG.md` from package version `2.8.0` onward only; historical versions before `2.8.0` are not backfilled. Protocol schema for this release is `7.0`.
...
- [2026-06-27T14:10+08:00] Added `CHANGELOG.md` using Keep a Changelog structure, starting at package version `2.8.0`.
