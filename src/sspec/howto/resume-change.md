...
1. **memory.md** — find newest Session Log entry → read **Next** items; scan Working Memory for key file list and recent decisions
...
- If memory.md says `Next: awaiting user approval`, your first action is alignment — not implementation.
- If tasks.md progress and memory.md `Next` conflict, memory.md wins (more recent).
