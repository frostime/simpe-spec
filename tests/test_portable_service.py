...
def test_list_builtin_skills_contains_metadata() -> None:
    ...
    assert by_name['sspec-design'].location == 'builtin:sspec-design'
...
def test_read_rule_sspec_wraps_rendered_source() -> None:
    ...
    assert '<read_command>sspec portable read rule:sspec</read_command>' in output
...
def test_read_skill_wraps_source_metadata() -> None:
    ...
    assert '<read_command>sspec portable read skill:sspec-design</read_command>' in output
